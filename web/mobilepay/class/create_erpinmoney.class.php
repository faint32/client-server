...
class ErpInMoney
{
	function create_erpinmoney($memid,$paymoney){
      ...
      if($db->nf()){
        ...
        //绑定ERP客户
        if(empty($cusname)){			 		          	           
          $cusno = "ZB".strtoupper($this->c($comnpany)).randstr().""; 
          //生成客户编号
        ...
        $pjlistno = $this->listnumber_update2(10);  //票据编号
        ...
        $sklistno = $this->listnumber_update2(8);  //票据编号
        ...
        $this->zbcurrentaccount(1 , $insert_cusid , $addmoney ,$paymoney , $ctatmemo , $cactlisttype , $xt , $sklistid , $sklistno ,$nowdate  , $quyuid , $skmscid);
        	               
        $this->changemoney(1 , $insert_cusid ,$paymoney , 1 , 1  , $quyuid , $skmscid , 1);  //修改应收应付款函数，0代表正，1代表负数
        
        $this->changeaccount($skaccountid , $paymoney , 0);    //调用修改帐户金额的函数
        ...
        $this->cashglide($skaccountid , $paymoney , $chgememo , $chgelisttype , $xt , $sklistid , $sklistno , $cogetype ,$nowdate );
