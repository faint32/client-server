...
{
  var $prgnoware    = array("刷卡器购销","销售发货");
  ...
  var $browse_find = array(		// 查询条件
	...
	"4" => array("经手人"      ,   "fd_selt_dealwithman"  ,"TXT"),
	"4" => array("录单人"      ,   "fd_selt_ldr"  ,"TXT"),
  );
  ...
  function makeedit($key) {// 生成编辑连接
    ...
    {//判断记录是在那一个状态下，在那一个状态下就使用那一个连接
      case "1":
        ...
        break;
      case "0":
        $returnval = "<a href=javascript:linkurl(\"sale_sq_view.php?backstate=0&listid=".$key."\")>查看</a>" ;
        break;
    }
    return $returnval;
  }
