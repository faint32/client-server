...
if($db->nf()){
    ...
    switch($vlisttype){
    	...
    	case "4":
    	  $vlisttype = "对外销售退货单";
<<<<<<< .mine
    	  $viewname = "<span onclick=\"chaxun('../jxc/salebackview.php','listid',".$vlistid.",this)\" style='cursor:hand'>查看详细</span>";
=======
    	  $viewname = "<span onclick=\"chaxun('../jxc/salebacklistview.php','listid',".$vlistid.")\" style='cursor:hand'>查看详细</span>";
>>>>>>> .r3507
    	  break;
      case "0":
    	  $vlisttype = "期初开帐";
