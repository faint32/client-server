...
class tb_salelist_b extends browse {
	 var $prgnoware    = array("刷卡器购销","销售退货历史");
	 var $prgnowareurl =  array("","",);
	 
	 var $browse_key = "fd_selt_id";
	 
	 var $browse_queryselect = "select fd_selt_id , fd_selt_no , fd_selt_cusno , fd_selt_cusname ,fd_selt_allmoney,fd_selt_allcost,fd_selt_ldr ,fd_selt_dealwithman , fd_selt_allquantity,
	 							fd_selt_date ,fd_selt_skfs
...
class lk_view0 extends browselink {
   ...
   var $bwlk_prgname = "salebacklistview.php?listid=";
   var $bwlk_title ="明细帐";  
}
...
$tb_salelist_bu = new tb_salelist_b ;
  ...
  $tb_salelist_bu->browse_field = array("fd_selt_no","fd_selt_cusno","fd_selt_cusname","fd_selt_date","fd_selt_skfs","fd_selt_allquantity","fd_selt_allmoney","fd_selt_allcost","fd_selt_ldr","fd_selt_dealwithman");
...
$tb_salelist_bu->browse_collectquery = "select sum(fd_selt_allmoney) as collectmoney,sum(fd_selt_allcost) as collectcost  from tb_salelistback";
