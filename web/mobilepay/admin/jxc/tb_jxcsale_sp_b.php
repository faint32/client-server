...
class tb_salelist_b extends browse {
  ...
  var $browse_queryselect = "select fd_selt_id , fd_selt_no , fd_selt_cusno , fd_selt_cusname , fd_selt_date ,fd_selt_ldr,fd_selt_dealwithman, fd_selt_skfs , fd_selt_state,fd_selt_allquantity from tb_salelist";
  var $browse_edit = "jxcsale_sp.php?listid=";
  ...
  {// 生成编辑连接
    ...
    {//判断记录是在那一个状态下，在那一个状态下就使用那一个连接
      case "2":
        ...
        break;
      case "0":
        $returnval = "<a href=javascript:linkurl(\"sale_sq_view.php?backstate=1&listid=".$key."\")>查看</a>";
        break;
    }
    return $returnval;
  }

  var $browse_field = array("fd_selt_state","fd_selt_no","fd_selt_cusno","fd_selt_cusname","fd_selt_allquantity","fd_selt_date","fd_selt_ldr","fd_selt_dealwithman","fd_selt_skfs");
...
$tb_salelist_bu->browse_querywhere .= "(fd_selt_state = 2) ";
