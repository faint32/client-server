...
class tb_paycardstock_b extends browse {
	 var $prgnoware    = array("刷卡器购销","入库历史");
	 ...
	 function docollect(){  //汇总函数
      ...
      $this->browse_collectdata = "进货总金额为：".$collectmoney."&nbsp;&nbsp;&nbsp;进货总数为：".$collectquantity;
   }
	 ...
	 var $browse_field = array("fd_stock_no","fd_stock_suppno","fd_stock_suppname","fd_stock_ldr","fd_stock_dealwithman","fd_stock_allquantity","fd_stock_allmoney");
 	 var $browse_find = array(		// 查询条件
				...
				"4" => array("经手人"      ,   "fd_stock_dealwithman"       ,"TXT"),
				"4" => array("录单人"      ,   "fd_stock_ldr"       ,"TXT"),
				);
