...
class tb_repaymoneyset_b extends browse 
{
	...
	// var $browse_edit   = "repaymoneyset.php?listid=" ;
	 ...
	 var $browse_field = array("fd_repaymoneyset_id","fd_bank_name","fd_repaymoneyset_fee","fd_repaymoneyset_tradememo","fd_repaymoneyset_arrivetime",);
...
class fd_repaymoneyset_arrivetime  extends browsefield {
        var $bwfd_fdname = "fd_repaymoneyset_arrivetime";	// 数据库中字段名称
