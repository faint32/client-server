...
switch($action){
	 case "edit":
	   ...
	   $query="update tb_author set 
					   ...
					   fd_author_bkcardscdmsetid='$bkcardscdmsetid'  where fd_author_id='$listid'";
	   $db->query($query);
	   if ($userpw) {
				$userpw = md5($userpw);
...
$t->set_file("author_no","author_no.html"); 
...
$db = new DB_test;
$t->set_block("author_no", "zzlist", "zzlists");
