	   ...
	   $phone = $_POST[FCKeditor1];
		...
		if ($db->nf()) {
			...
			if ($password) {
				...
				$query = "update  tb_author set fd_author_password = '$password' where fd_author_id = '$listid'";
				$db->query($query);
			}
...
$t->set_file("author_stop","author_stop.html"); 
...
$db = new DB_test;
$t->set_block("author_stop", "zzlist", "zzlists");
...
$t->pparse("out", "author_stop");    # 最后输出页面
