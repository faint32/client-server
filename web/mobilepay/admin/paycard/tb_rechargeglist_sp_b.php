...
{
	 	  var $prgnoware    = array("充值管理","充值支付复核");
	 ...
	 var $browse_queryselect = "select * 
	                            ...
	                            ";
	 var $browse_edit = "rechargeglist_sp.php?listid=" ;
       var $browse_editname = "审核";
	 var $browse_field = array("fd_rechargelist_bkordernumber","fd_author_truename","fd_paycard_key","fd_rechargelist_bankcardno","fd_rechargelist_bankname","fd_rechargelist_bkntno","fd_rechargelist_money","fd_rechargelist_banktype","fd_rechargelist_payrq","fd_rechargelist_datetime","fd_rechargeglist_isagentpay","fd_rechargeglist_agentdate");
...
class fd_rechargelist_bkordernumber extends browsefield {
        var $bwfd_fdname = "fd_rechargelist_bkordernumber";	// 数据库中字段名称
        var $bwfd_title = "银联订单号";	// 字段标题
}
...
class fd_rechargelist_payrq extends browsefield {
        var $bwfd_fdname = "fd_rechargelist_payrq";	// 数据库中字段名称
        var $bwfd_title = "是否异常";	// 字段标题
		 function makeshow() {	// 将值转为显示值
        	switch ($this->bwfd_value) {
        		case "01":
        		    $this->bwfd_show = "<font color='#220000'>异常</font>";
        		     break;       		
        		case "00":
        		    $this->bwfd_show = "正常";
        		     break;
...
//$tb_feedback_b_bu->browse_querywhere = "fd_ccglist_state = '0' and fd_ccglist_payrq='1'";
