...
class tb_feedback_b extends browse {
	...
	var $browse_queryselect = "select * from tb_authoraccount
	                            ...
	                            ";
	var $browse_edit = "account.php?listid=";
	var $browse_editname = "详细";
	var $browse_field = array ("fd_acc_id", "fd_author_truename", "fd_acc_typeno", "fd_acc_typename", "fd_acc_money" );
	var $browse_find = array (// 查询条件
		"0" => array ("序号", "fd_acc_id", "TXT" ), 
		"1" => array ("用户名", "fd_author_truename", "TXT" ),
		"1" => array ("账户类型", "fd_acc_typename", "TXT" ), 
	 	"1" => array ("金额", "fd_acc_money", "TXT" ) );
