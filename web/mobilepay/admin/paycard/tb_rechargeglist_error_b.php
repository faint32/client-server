...
{
	 var $prgnoware    = array("充值管理","充值支付异常");
	 ...
	 var $browse_queryselect = "select * 
	                            ...
	                            ";
	 var $browse_edit = "rechargeglist_sp.php?type=error&listid=" ;
    var $browse_editname = "查看";
	 var $browse_field = array("fd_rechargelist_no","fd_author_truename","fd_paycard_key","fd_rechargelist_bankcardno","fd_rechargelist_bankname","fd_rechargelist_bkntno","fd_rechargelist_money","fd_rechargelist_banktype","fd_rechargelist_datetime","fd_rechargeglist_isagentpay","fd_rechargeglist_agentdate");
...
$tb_feedback_b_bu->browse_querywhere = "fd_rechargelist_payrq='01'";
