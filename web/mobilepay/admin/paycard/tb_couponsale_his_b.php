...
{
	 var $prgnoware    = array("抵用劵管理","抵用卷购买历史");
   ...
   var $browse_link  = array("lk_view0");
	 ...
	 var $browse_field = array("tdcount","fd_author_truename","fd_author_username","fd_author_idcard","fd_couponsale_paymoney","fd_couponsale_payfee","fd_couponsale_money","fd_couponsale_sdcrpayfeemoney","fd_couponsale_payfeedirct","fd_sdcr_name","fd_couponsale_datetime","fd_paycard_no","fd_couponsale_creditcardno","fd_couponsale_creditcardbank","fd_couponsale_bkordernumber","fd_couponsale_bkntno","fd_couponsale_isagentpay","fd_couponsale_agentdate");
 	 ...
 	 var $browse_find = array(		// 查询条件			
				"1" => array("抵用劵金额", "fd_couponsale_money","TXT"),
				"2" => array("刷卡器号", "fd_paycard_no","TXT"),
				"3" => array("用户账号", "fd_author_username","TXT"),
				"4" => array("用户姓名", "fd_author_truename","TXT"),
				"5" => array("身份证号", "fd_author_idcard","TXT"),
				"6" => array("单据日期", "fd_couponsale_datetime","TXT"),
				"7" => array("操作人", "fd_couponsale_czman","TXT"),
				"8" => array("操作日期", "fd_couponsale_czdatetime","TXT"),
				"9" => array("银行交易流水号", "fd_couponsale_bkntno","TXT")
				);
...
class lk_view0 extends browselink {
   var $bwlk_fdname = array(			// 所需数据库中字段名称
   			    "0" => array("fd_couponsale_id") 
   			    );
   var $bwlk_prgname = "couponsale_view.php?listid=";
   var $bwlk_title ="查看明细";  
}
...
$tb_feedback_b_bu->browse_querywhere = "fd_couponsale_state = 9";
