...
{
	 var $prgnoware    = array("信用卡还款管理","信用卡还款支付历史");
	 ...
	 var $browse_edit = "creditcard_sp.php?type=check&listid=" ;
...
$tb_feedback_b_bu->browse_querywhere = "fd_ccglist_state = '9' and fd_ccglist_payrq='00'";
