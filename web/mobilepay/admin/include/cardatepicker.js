...
function createDatePicker(txtName,lYear,lMonth,lDay,flag)
{
	...
	if(flag==0)    //flag=0就日期就可以修改,其他就不能修改
	{     
	   document.write("<span class=DPFrame id="+dpID+" >");
	   document.write("<input class=DPYear type=text value="+dt.getFullYear()+" size=4 maxlength=4 onfocus=\"return dp_focus('year');\" onblur=\"return dp_blur('year')&& odue()|| odue2();\" onkeypress=\"return KeyFilter('number');\" onkeydown=\"return dp_keyDown('year');\" >");
	   document.write("<font class=DPYearDes>年</font>");
	   document.write("<input class=DPMonth type=text value="+(dt.getMonth()+1)+" size=2 maxlength=2 onfocus=\"return dp_focus('month');\" onblur=\"return dp_blur('month')&& odue()|| odue2();\" onkeypress=\"return KeyFilter('number');\" onkeydown=\"return dp_keyDown('month');\" >");
	   document.write("<font class=DPMonthDes>月</font>");
	   document.write("<input class=DPDay type=text value="+dt.getDate()+" size=2 maxlength=2 onfocus=\"return dp_focus('day');\" onblur=\"return dp_blur('day')&& odue()|| odue2();\" onkeypress=\"return KeyFilter('number');\" onkeydown=\"return dp_keyDown('day');\" >");
