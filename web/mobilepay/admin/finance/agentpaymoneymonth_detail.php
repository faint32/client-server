...
$dbtj = new DB_test ;
$t = new Template('.', "keep");
$t->set_file("agentpaymoneymonth_detail","agentpaymoneymonth_detail.html");
$t->set_block ( "agentpaymoneymonth_detail", "prolist", "prolists" );
if(!empty($type)){
	switch ($type){
		case "all":
...
$query="select  case
          ...
          where fd_agpm_payrq = '00' and fd_agpm_isagentpay = '1' $where and date(fd_agpm_agentdate) = '$listdate'";
...
$t->pparse("out", "agentpaymoneymonth_detail");    # 最后输出页面
?>