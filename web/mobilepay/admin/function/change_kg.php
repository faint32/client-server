<?
//计算商品数量的吨数
function changekg_new($relation3 , $unit , $quantity){
	switch($unit){
		case "令":
...
//计算令数
function changeling_new($relation1 , $relation2 , $relation3 , $unit , $quantity){
	switch($unit){
		case "张":
...
//计算件数
function changejian_new($relation1 , $relation2 , $relation3 , $unit , $quantity){
	switch($unit){
		case "张":
