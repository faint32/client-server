...
$t = new Template('.', "keep");
$t->set_file("qqrecharge_list","qqrecharge_list.html");
$t->set_block("qqrecharge_list", "HEADBXBK", "headbxbks");
...
$t->pparse("out", "qqrecharge_list");    # 最后输出页面
