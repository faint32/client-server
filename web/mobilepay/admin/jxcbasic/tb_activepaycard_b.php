...
class tb_paycardactivelist_b extends browse {
	...
	var $browse_queryselect = "select * from  tb_paycardactivelist 
								...
								";
	var $browse_edit = "activepaycard.php?listid=";
	var $browse_editname = "查看";
	//var $browse_new   = "pcdactive.php" ;
	

	var $browse_field = array ("fd_pcdactive_id", "fd_author_truename", "fd_paycard_key", "fd_paycard_scope", "fd_pcdactive_activedate", "fd_saler_truename", "fd_bank_name" );
	var $browse_find = array (// 查询条件
"0" => array ("刷卡器设备号", "fd_paycard_no", "TXT" ), "1" => array ("激活时间", "fd_pcdactive_activedate", "TXT" ), "2" => array ("网导", "fd_saler_truename", "TXT" ), "3" => array ("操作人", "fd_author_truename", "TXT" ) );
}
...
$tb_paycardactivelist_b_bu->browse_delqx = $thismenuqx [3]; // 删除权限
$tb_paycardactivelist_b_bu->browse_addqx = $thismenuqx [1]; // 新增权限
$tb_paycardactivelist_b_bu->browse_editqx = $thismenuqx [2]; // 编辑权限
//$tb_paycardactivelist_b_bu->browse_link  = array("lk_view0");
$tb_paycardactivelist_b_bu->main ( $now, $action, $pagerow, $order, $upordown, $checknote, $prgnoware, $prgnowareurl, $pagerows, $whatdofind, $howdofind, $findwhat, $allcondition );
?>
