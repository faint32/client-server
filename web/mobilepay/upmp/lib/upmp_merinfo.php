...
class customer_config
{
    ...
    static $mer_back_end_url    	= "http://14.18.207.56/mobileypay/upmp/upmp_feedback.php"; // 后台通知地址
    static $mer_front_end_url   	= "http://14.18.207.56/mobileypay/upmp/upmp_feedback.php"; // 前台通知地址
