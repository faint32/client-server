...
class customer_config
{
    ...
    static $mer_id     				= "880000000000497"; // 商户号
    static $security_key    		= "JqMzcZCuF1xBZqSvKoZvpa1zvnAIxW4E"; // 商户密钥
    
    
    static $mer_back_end_url    	= "http://www.tfbpay.cn/mobileypay/upmp/upmp_feedback.php"; // 后台通知地址
    static $mer_front_end_url   	= "http://www.tfbpay.cn/mobileypay/upmp/upmp_feedback.php"; // 前台通知地址
