...
class upmp_config
{
    ...
    static $mer_id     		    = "898440048990007"; // 商户号
    static $security_key           = "gzEZPg2pSRKt9SXbPkcKS7BV7TArNzxb"; // 商户密钥
    static $mer_back_end_url    	= "http://www.tfbpay.cn/tfb_test/third_api/upmp_feedback.php"; // 后台通知地址
    static $mer_front_end_url   	= "http://www.tfbpay.cn/tfb_test/third_api/upmp_feedback.php"; // 前台通知地址
